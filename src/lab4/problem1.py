...
PATH_TO_INPUT1 = 'input_1.txt'  # Задаем путь к первому файлу (по условию задачи он должен быть доступен к изменению)
PATH_TO_INPUT2 = 'input_2.txt'  # Аналогично задаем путь ко второму файлу
...
if __name__ == '__main__':  # Если файл запущен как главный
    with open(PATH_TO_INPUT1, 'r', encoding='utf-8') as file1_input:  # Открываем первый файл
        ...
        films_db = FilmsDB(films)  # Создаем объект базы данных фмльмов
